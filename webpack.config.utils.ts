...
export const getEntry = (sourceDir = Directories.SRC_DIR) => {
    return {
        ...
        onBoarding: [path.resolve(__dirname, `${sourceDir}/onBoarding/index.tsx`)],
    };
};
    ...
    return [
        new CopyWebpackPlugin({
            patterns: [
                ...
                {
                    from: path.resolve(__dirname, `${sourceDir}/redirect.html`),
                    to: path.resolve(__dirname, `${outputDir}/${browserDir}/`),
                },
            ],
        }),
    ];
    ...
    return [
        new ExtReloader({
            ...
            entries: {
                ...
                extensionPage: ['popup', 'options', 'onBoarding'],
            },
        }),
    ];
};
