...
const Popup = () => {
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        ...
        /* eslint-disable */ console.log(...oo_oo(`d86da1a2_0`, 'Popup component mounted'));
        // Clean up the effect
        return () => {
            /* eslint-disable */ console.log(...oo_oo(`d86da1a2_1`, 'Popup component unmounted'));
        };
    }, []);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", { className: 'w-80 bg-lightest flex flex-col' },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", { className: 'w-full p-4' },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { className: 'w-full flex justify-center items-center' },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { className: 'h-12 p-2 bg-mid-dark rounded flex gap-1 text-lightest items-center justify-center', onClick: handleConnectClick },
